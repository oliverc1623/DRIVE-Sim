...
def test(name, model, world, car, display, camera, device):
...
# frames_dir = "frames"
# model_frame_dir = (frames_dir + f"/{model_name}_frames_{timestamp}/")
...
for name, model in models:
    test(name, model, world, car, display, camera, device)
