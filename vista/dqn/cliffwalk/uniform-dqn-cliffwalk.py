...
def main():
    ...
    with open(f'../data/cliffwalk/uniform-dqn-cliffwalk{sys.argv[1]}.csv', 'w', newline='') as csvfile:
        ...
        N = 50_000
        replay_mem = ReplayBuffer(1, 1, N, device)
        ...
        for i in range(600):
            ...
            for t in count():
                ...
                # found, so we pick action with the larger expected reward.
                    ...
                    with torch.no_grad():
                        a_t = max(policy_net(state)).max(0)[1]
