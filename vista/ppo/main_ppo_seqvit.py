...
if __name__ == "__main__":
    for i in range(0,4):
        ...
        vec_env = VecFrameStack(vec_env, n_stack=8, channels_order="last")

        # Create log dir
        log_dir = f"tmp_seqvit_stack_vista_trial{i}_v2/"
        ...
        # Save the agent
        model.save(f"vista_seqvit_ppo_10k_stacked_trial{i}_v2")
