...
def train():
    ...
    env_name = "DynamicObstaclesStudentInference"
    ...
    ppo_agent.policy.load_state_dict(torch.load("PPO_preTrained/DynamicObstaclesStudent/PPO_DynamicObstaclesStudent_46_0.pth"))
    ppo_agent.policy_old.load_state_dict(torch.load("PPO_preTrained/DynamicObstaclesStudent/PPO_DynamicObstaclesStudent_46_0.pth"))
